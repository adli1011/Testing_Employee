      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a href="cdtadminsearch.jsp" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Search Candidate
              </p>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card card-primary card-outline">
                <form action="updateAdminForm.jsp" method="POST">
              <div class="card-body">
                ...
                <h3 class="text-primary"><i class="fas fa-paint-brush"></i> Profile</h3>
                 ...
                 <strong><i class="fas fa-pencil-alt mr-1"></i> Admin IC</strong>
                <p class="text-muted">
                 ${admin.admIC}
                 <input type="hidden" name="admIC" value="${admin.admIC}"></td> 
                </p>

                <hr>
               <strong><i class="fas fa-book mr-1"></i> Admin Name</strong>
                <p class="text-muted">
                  ${admin.admName} 
                  <input type="hidden" name="admName" value="${admin.admName}">
                </p>
                <hr>
              <strong><i class="fas fa-book mr-1"></i> Phone Number</strong>
                <p class="text-muted">
                  ${admin.admNumTel}
                  <input type="hidden" name="admNumTel" value="${admin.admNumTel}">
                </p>
                <hr>
                <strong><i class="fas fa-map-marker-alt mr-1"></i>Address</strong>

                <p class="text-muted"> ${admin.admAddress}</p>
                <input type="hidden" name="admAddress" value="${admin.admAddress}">
                <hr>
                ...
                <p class="text-muted">
                  ${admin.admEmail}
                  <input type="hidden" name="admEmail" value="${admin.admEmail}">
                </p>
                </c:forEach>
