              ...
              <div class="card-body">
                ...
                <table class="table table-hover text-nowrap">
                  <thead>
                      ...
                      <th>Candidate ID</th>
                      <td>${cdt.cdtid}</td>
                      <input type="hidden" name="cdtid" value="${cdt.cdtid}">
                    </tr>
                    <tr>
                      <th>Candidate Name</th>
                      <td>${cdt.cdtName}</td>
                      <input type="hidden" name="cdtName" value="${cdt.cdtName}">
                    </tr>
                    <tr>
                      <th>Phone Number</th>
                      <td>${cdt.cdtTell}</td>
                      <input type="hidden" name="cdtName" value="${cdt.cdtTell}">
                    </tr>
                    <tr>
                      <th>Email</th>
                      <td>${cdt.cdtEmail}</td>
                      <input type="hidden" name="cdtEmail" value="${cdt.cdtEmail}">
                    </tr>
            
                    <tr>
                      <th>Address</th>
                      <td>${cdt.cdtAddress}</td>
                      <input type="hidden" name="cdtAddress" value="${cdt.cdtAddress}">
                    </tr>
                    
                  </thead>
                   <div class="col-12">
                    <input type="submit" value="Delete candidate" class="btn btn-success float-right">
                    </div>
                </table>
