<%-- 
    ...
    Created on : Jul 21, 2021, 4:03:52 PM
    Author     : Hanna
--%>
        ...
        <div class="container-fluid">
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="EditPassAdminController.do" method="post">
                  <% String admIC = (String)session.getAttribute("currentSessionUser"); %>
                   <sql:query var="result" dataSource="${myDatasource}">
                    SELECT *  FROM ADMIN WHERE ADMIC = '<%=admIC %>'
                    </sql:query>
                    <c:forEach var="adm" items="${result.rows}">
                <div class="card-body">
                  <div class="form-group">
                    <label for="orgID">Admin IC </label>
                    <input type="text" class="form-control" name="admIC" value="<c:out value='${adm.admIC}' />" readonly>
                  </div>
                  <div class="form-group">
                    <label>Admin Name </label>
                    <input type="text" class="form-control" name="admName" value="<c:out value='${adm.admName}' />" readonly>
                  </div>
                  <div class="form-group">
                    <label>Password </label>
                    <input type="password" class="form-control" name="admPass" >
                  </div>
                  <div class="form-group">
                    <label >Confirm Password </label>
                    <input type="password" class="form-control" name="admPassCom">
                  </div> 
                </div>
                <!-- /.card-body -->
                <center>
