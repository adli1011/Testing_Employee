...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="loginStaff.jsp" class="h1"><b>STAFF</b></a>
    </div>
    <div class="card-body">
      ...
      <form  action="LoginStaff.do" method="POST"> 
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="staffId" id="staffId" placeholder="Enter id" required>
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" name="staffPass" id="staffPass" placeholder="Password" required>
          <div class="input-group-append">
            <div class="input-group-text">
